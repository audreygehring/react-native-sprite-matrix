...
export default class matrix extends Component {
  constructor(props) {
    ...
    this.activeCells =  [true, true, true, true, true, true, true, true, true, true, true, true];
		this.animationKeys = ["FLY", "ANNOYED", "ANNOYED", "EAT", "ANNOYED", "ANNOYED", "ANNOYED", "ANNOYED", "ANNOYED", "ANNOYED", "ANNOYED", "ANNOYED"];
    this.loopAnimation = _.fill(Array(this.activeCells.length), false);
    this.sprites = _.fill(Array(this.activeCells.length), birdSprite);
    this.scale = {image: 1};
  ...
  cellPressed (cellObj, position) {
    ...
    if (cells[position].animationKey === "FLY") {
      cells[position].animationKey = "EAT";
    } else {
      cells[position].animationKey = "FLY";
    }
